...
export const CreateUrlModel = ({ fetchUrls }) => {
  ...
  console.log(createUrlError);

  return (
    <Dialog defaultOpen={longUrl} onOpenChange={(v) => {
      if (!v) setSearch({})
    }}>
      <DialogTrigger className="bg-primary text-primary-foreground hover:bg-primary/90 px-2 py-1 rounded-lg font-lato">
        Create Link
      </DialogTrigger>
        ...
        <DialogHeader className="space-y-5">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <Input type={'url'} id='url' {...register("url")} placeholder="https://example.com" />
              {errors.url && (
